...
```
npm explore cssj -- npm run watch
```

Второй вариант позволяет отслеживать изменения в файлах и делать ребилд собранного CSS файла (только в тех директориях в которых уже были файлы).
&nbsp;
